...
final class EventsWithHeader {
    ...
    public static Descriptors.Descriptor descriptorForTypeWithHeader(Descriptors.Descriptor classDescriptor)
                throws Descriptors.DescriptorValidationException {
        Collection<Descriptors.FieldDescriptor> allFields = new LinkedList<>();
