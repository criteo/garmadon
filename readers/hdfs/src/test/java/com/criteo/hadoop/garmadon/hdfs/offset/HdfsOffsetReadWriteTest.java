...
public class HdfsOffsetReadWriteTest {
    ...
    public void test() throws IOException {
        ...
        try {
            ...
            final HdfsOffsetComputer hdfsOffsetComputer = new HdfsOffsetComputer(
                    localFs, basePath, new TrailingPartitionOffsetPattern());

            final TrailingPartitionOffsetFileNamer fileNamer = new TrailingPartitionOffsetFileNamer();
