...
public class TeraGenGarmadon extends Configured implements Tool {
    ...
    public static class SortGenMapper
        ...
        protected void setup(Context context) throws IOException, InterruptedException {
            sampler = new TinySampler("Mapper", Thread.currentThread(), 1000);
            sampler.start();
            super.setup(context);
        }
        ...
        public void cleanup(Context context) {
            ...
            try {
                sampler.stop().outputTo(System.out);
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
    ...
    public int run(String[] args)
        ...
        job.setJarByClass(TeraGenGarmadon.class);
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new TeraGenGarmadon(), args);
        System.exit(res);
    }
}
