package com.criteo.hadoop.garmadon.common;
...
public class ElasticSearchReader implements BulkProcessor.Listener {
    ...
    private void putBodySpecificFields(Object o, Map<String, Object> jsonMap) {
        if (o instanceof DataAccessEventProtos.PathEvent) {
            ...
            jsonMap.put("cat", "container_resources");
    ...
    public long searchEs(QueryBuilder qb) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (InputStream streamPropFilePath = Forwarder.class.getResourceAsStream("/reader.properties")) {
